...
# --- Configurazione ---
APP_NAME = "AniDownloader_GUI"
ENTRY_POINT = "AniDownloaderGUI/main.py"  
# --------------------
...
def get_platform_specific_args():
    ...
    add_data_args = [
        ...
        f'--add-data=AniDownloaderGUI/core{separator}AniDownloaderGUI/core',
        f'--add-data=AniDownloaderGUI/gui{separator}AniDownloaderGUI/gui',
        f'--add-data=AniDownloaderGUI/utils{separator}AniDownloaderGUI/utils'
